// Adaptation of Joe Marshall's "Hacking the Stack" (c.f. https://www2.ccs.neu.edu/racket/pubs/stackhack4.html)
...
const Tak = (function() {
    ...
    function _takPause() {
        //print("takPause at " + _callcount);
        _breakat = _callcount + _breakevery;
        //print("next pause at " + _breakat);
    ...
    class TakFrame1 extends ContinuationFrame {
        ...
        apply(/* generic object */ resumeValue) { /* generic object */
            return _takAn1(resumeValue, this.x, this.y, this.z);
        }
    }
    ...
    return class {
        ...
        static taktest() {
            ...
            // print("callcount = " + _callcount);
            _callcount = 0;
            _breakevery = 2;
            _breakat = _breakevery;
            print("tak (18, 12, 6) = " + _takgo(18, 12, 6));
        }
    };
}());
