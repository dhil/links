...
let count_eff = IR.Make.fn("count_eff", [], undefined,
...
let funs = {'fact': factorial, 'count': count, 'choice':choice_comp, 'toss':toss_comp,
            'count_eff': count_eff, 'shallow_state_get_fn': shallow_state_get_fn, 'shallow_state_put_fn': shallow_state_put_fn, 'state': shallow_state_handler};
