...
let count0 = IR.Make.fn("count", ["n"], undefined,
                       IR.Make.computation([IR.Make.binding("b", IR.Make.apply(IR.Make.variable("%le"), [IR.Make.variable("n"), IR.Make.constant(0)]))],
                                           IR.Make.ifthenelse(IR.Make.variable("b"),
...
let count_eff0 = IR.Make.fn("count_eff", [], undefined,
                           IR.Make.computation([IR.Make.binding("n", IR.Make.doOperation("Get", IR.Make.unit)),
                                                IR.Make.binding("b", IR.Make.apply(IR.Make.variable("%le"), [IR.Make.variable("n"), IR.Make.constant(0)]))],
                                               IR.Make.ifthenelse(IR.Make.variable("b"),
                                                              IR.Make.computation([], IR.Make.ret(IR.Make.variable("n"))),
                                                                  IR.Make.computation([IR.Make.binding("m", IR.Make.apply(IR.Make.variable("%int_sub"), [IR.Make.variable("n"), IR.Make.constant(1)])),
...
// // let program = IR.Make.computation([], IR.Make.apply(IR.Make.variable("state"), [IR.Make.constant(1000000), IR.Make.variable("count_eff")]));
// // //let program = IR.Make.computation([], IR.Make.apply(IR.Make.variable("count"), [IR.Make.constant(1000000)]));
