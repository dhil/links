...
let result  = CEK.run({'%eq': {'value': "%eq"}, '%leq': {'value': "%leq"}, '%sub': {'value': "%sub"}, '%mult': {'value': "%mult"}, '%print': {'value':"%print"}, 'fact': factorial, 'count': count}, program);
