...
//var _idy = _lsCons(function(y, ks) { _efferr(y, ks) }, _lsSingleton(function(y, ks) { y(_efferr, ks) }));
//var _idy = _lsSingleton(function(y, ks) { y(_efferr, ks) });
...
// The toplevel handler simply throws an error
function _efferr(y, ks) {
    _error("Unhandled operation `" + y._label + "'."); // TODO: More descriptive error message
}
