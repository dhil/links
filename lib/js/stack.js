                ...
                if (!discontinue) {
                    ...
                    try {
                        ...
                        if (e instanceof PerformOperationError) {
                            ...
                            // Augment the pure continuation with the unevaluated frames
                            //throw new InitialHandleError(e, pureFrames.tail);
                            e.pureContinuation.append(pureFrames.tail);
                            e.continuation.instantiateTrapPoint(handler);
                    ...
                    try {
                        ...
                        if (e instanceof PerformOperationError) {
                            ...
                            e.continuation.instantiateTrapPoint(frames.tail.head.handler);
                            e.pureContinuation.compose(frames.tail.head.pureContinuation);
                            e.continuation.append(frames.tail.tail);
                            throw e;
                            throw new HandleError(e);
                        } else {
                            throw e;
